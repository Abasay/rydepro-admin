...
const ServiceTable = ({
  ...
  services: Service[];
  setShowSetup: (vlue: boolean) => void;
  setSelectService: (service: Service) => void;
  deleteService: (id: string) => void;
}) => {
  return (
    <section className=' mt-6 flex flex-col gap-4 px-6 min-h-[300px] max-h-[771px]'>
      <div className=' flex justify-between items-center w-full'>
        <h3 className='text-[#2B2B2B]  text-2xl font-bold'>Service Types List</h3>

        <button
          className=' w-[195px] h-[56px] bg-[#1C2951] rounded-lg p-2 justify-center text-[#FFFFFF] text-lg'
              ...
              <tr className=' text-[#0E0E0E] flex items-end pb-1 pt-1 tracking-widest text-sm font-medium'>
                ...
                <th className=' flex items-start gap-12 min-w-[1124px] mr-12'>
                  ...
                  <th className='py-2 min-w-[140px] max-w-[140px] flex gap-2'>
                    <span>Service Type</span> <UpsAndDowns />
                  </th>{' '}
                ...
                <th className='py-2 min-w-[124px] max-w-[240px] flex gap-2'>Actions</th>
              </tr>
            </thead>
                ...
                services.map((item, index) => (
                  <tr key={index} className='border-b flex pt-2 hover:bg-gray-50'>
                    ...
                    <td className='flex items-start gap-12 min-w-[1124px] mr-12'>
                      ...
                      <td className='py-3 min-w-[140px] max-w-[140px]'>{item.serviceName}</td>
                      <td className='py-3 min-w-[124px] max-w-[124px]'>{item.code}</td>
                      <td className='py-3 min-w-[184px] max-w-[184px]'>{item.description}</td>
                      <td className='py-3 min-w-[164px] max-w-[164px]'>{item.type}</td>
                    ...
                    <td className=' flex gap-12 min-w-[300px]'>
                      <td className='py-2 flex items-start gap-4 min-w-[124px] max-w-[124px]'>
                        ...
                        <button className='' onClick={() => deleteService(item._id)}>
                          {/* <svg
                            width='20'
                            height='20'
                            viewBox='0 0 20 20'
