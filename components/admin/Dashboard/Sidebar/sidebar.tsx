...
const Sidebar = () => {
  const { isSettingsClicked, setIsSettingsClicked, adminDetails, setAdminDetails } = useDashboardContext();
              ...
              <div className=" flex flex-col gap-4">
                ...
                <div className=" relative flex flex-col gap-2 mx-auto py-1 pb-6 min-w-[200px] border-b max-w-[208px] border-[#EBEBEB]">
                  ...
                  <div className=" flex flex-col gap-[6px]">
                    ...
                    <button
                      className=" flex justify-between w-full mt-1 cursor-pointer items-center"
                      onClick={() => setActiveHeader('Zone')}
                    >
                      <span className=" text-[#3C3C3C] text-sm font-medium">Zones</span>
                      {false ? (
                        <span>
                          <svg
                            width="16"
        ...
        <div className=" flex justify-between w-full p-4 items-center pr-5">
          <div className=" flex gap-2 items-center">
            ...
            <div className=" flex gap-1 flex-col text-[#0E0E0E]">
              <span className="font-medium">{adminDetails?.username}</span>
