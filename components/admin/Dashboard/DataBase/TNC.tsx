...
const TNCTable = ({ tncDrivers }: { tncDrivers: any[] }) => {
  ...
  if (showSingleDriver) {
    return <SingleDriver driverType="tnc" />;
  }
        ...
        <thead className="bg-[#F8F8F8] pt-8 ">
          <tr className=" text-[#0E0E0E] flex pb-2 pt-2 items-end tracking-widest text-sm font-medium">
            ...
            <th className=" flex flex-col gap-1 items-center ">
              <th className=" flex gap-12 items-end min-w-[4200px] ">
            ...
            <tr key={user.id} className="border-b flex pt-2 hover:bg-gray-50">
              ...
              <td className="flex items-start gap-12 min-w-[1124px] mr-12">
                ...
                <td
                  ...
                  } ${user['Account Type'] === 'Chauffeur' && 'text-[#AC24CB] '} ${
                ...
                >
                  <span
                    ...
                    } ${user['Account Type'] === 'Chauffeur' && 'bg-[#FAE4FF] '} ${
                ...
                <td className="py-2 items-start  min-w-[164px] max-w-[164px]">{user.userId}</td>
                <td
              ...
              <td className=" flex flex-col gap-1 items-start min-w-[3020px] ">
