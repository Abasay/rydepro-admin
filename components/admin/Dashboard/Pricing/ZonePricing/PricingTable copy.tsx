          ...
          <table className=" text-left text-sm">
            <thead className="bg-[#F8F8F8] pt-8 h-9">
              <tr className=" text-[#0E0E0E] flex items-end pb-1 pt-1 tracking-widest text-sm font-medium">
                ...
                <th className="py-2 min-w-[160px] max-w-[160px] flex gap-2">
                  <span>Peak Hours Start</span>
                  <UpsAndDowns />
                </th>
                <th className="py-2 min-w-[160px] max-w-[160px] flex gap-2">
                  <span>Peak Hours End</span>
                  <UpsAndDowns />
                </th>
                <th className="py-2 min-w-[160px] max-w-[160px] flex gap-2">
                  <span>Peak Start Date</span>
                  <UpsAndDowns />
                </th>
                <th className="py-2 min-w-[160px] max-w-[160px] flex gap-2">
                  <span>Peak End Date</span>
                  <UpsAndDowns />
                </th>
                <th className="py-2 min-w-[160px] max-w-[160px] flex gap-2">
                ...
                <th className="py-2 min-w-[160px] max-w-[160px] flex gap-2">
                  <span>Surge Start Hour</span>
                  <UpsAndDowns />
                </th>
                <th className="py-2 min-w-[160px] max-w-[160px] flex gap-2">
                  <span>Surge End Hour</span>
                  <UpsAndDowns />
                </th>
                <th className="py-2 min-w-[160px] max-w-[160px] flex gap-2">
                ...
                pricings.map((item, index) => (
                  <tr key={index} className="border-b flex pt-2 hover:bg-gray-50">
                    ...
                    <td className="flex items-start gap-12 min-w-[1128px] mr-12">
                      ...
                      <td className="py-3 min-w-[200px] max-w-[200px]">{item.zoneFrom}</td>
                      <td className="py-3 min-w-[128px] max-w-[128px]">{item.zoneTo}</td>
