...
const DBHeader = () => {
  ...
  return (
    <div
      className={`h-[100px]  bg-[#FFFFFF] border-b-[1px] py-[8px] pr-[48px] pl-[32px] border-[#F1F1F1] flex items-center justify-between ${styles['slide-from-top']}`}
    >
      <div className=' min-w-[191px] flex gap-8 items-center'>
        <span className=' w-full text-[16px] leading-6 text-[#000000]'>
          Advanced Search
        </span>
